	...
	$gdlr_font_family = array( 									
		...
		'options' => array(
			...
			'content-font-family' => array(
				...
				'default' => 'Arial, Helvetica, sans-serif',
				'data-type' => 'font',
				'selector' => 'body, input, textarea, select, .gdlr-content-font{ font-family: #gdlr#; }'
			),			
			...
			'testimonial-quote' => array(
				'title' => __('Testimonial Quote', 'gdlr_translate'),
				'type' => 'font-combobox',
				'default' => 'ABeeZee',
				'data-type' => 'font',
				'selector' => '.gdlr-testimonial-carousel-icon{ font-family: #gdlr#; }'
			),
		)
	);	
