	...
	if( !function_exists('gdlr_generate_style_custom') ){
		function gdlr_generate_style_custom( $options ){
			...
			foreach($skins as $skin){
				...
				$style .= '#class# a:hover, #class# .gdlr-skin-link:hover, #class# .gdlr-skin-title a:hover{ color: ' . $skin['link-hover'] . '; }' . "\n"; 
				$style .= '#class# .gdlr-skin-box, #class# .flex-direction-nav a, #class# .gdlr-column-service-item .gdlr-skin-box{ background-color: ' . $skin['element-background'] . '; }' . "\n"; 
			...
			if(!empty($theme_option['service-slideshow-item-hover-background-top'])){
				$gdlra = gdlr_convert_rgba($theme_option['service-slideshow-item-hover-background']);
				$gdlrat = gdlr_convert_rgba($theme_option['service-slideshow-item-hover-background-top']);
				$gradient = '.service-slideshow-overlay{ background: -webkit-linear-gradient(rgba(#gdlrat#, 0.77), rgba(#gdlra#, 0.77));' . 
					'background: -o-linear-gradient(rgba(#gdlrat#, 0.77), rgba(#gdlra#, 0.77)); ' .
					'background: -moz-linear-gradient(rgba(#gdlrat#, 0.77), rgba(#gdlra#, 0.77)); ' .
					'background: linear-gradient(rgba(#gdlrat#, 0.77), rgba(#gdlra#, 0.77)); }';
				$gradient = str_replace('#gdlra#', $gdlra, $gradient);
				$gradient = str_replace('#gdlrat#', $gdlrat, $gradient);
				fwrite($file_stream, $gradient);
			}
			
			if(!empty($theme_option['portfolio-thumbnail-hover-background-top'])){
				$gdlra = gdlr_convert_rgba($theme_option['portfolio-thumbnail-hover-background']);
				$gdlrat = gdlr_convert_rgba($theme_option['portfolio-thumbnail-hover-background-top']);
				$gradient = '.gdlr-image-link-shortcode .gdlr-image-link-overlay, .portfolio-thumbnail .portfolio-overlay{ background: -webkit-linear-gradient(rgba(#gdlrat#, 0.77), rgba(#gdlra#, 0.77));' . 
					'background: -o-linear-gradient(rgba(#gdlrat#, 0.77), rgba(#gdlra#, 0.77)); ' .
					'background: -moz-linear-gradient(rgba(#gdlrat#, 0.77), rgba(#gdlra#, 0.77)); ' .
					'background: linear-gradient(rgba(#gdlrat#, 0.77), rgba(#gdlra#, 0.77)); }';
				$gradient = str_replace('#gdlra#', $gdlra, $gradient);
							...
							'options' => array(
								...
								'top-bar-color' => array(
									...
									'options' => array(						
										...
										'top-bar-icon-color' => array(
											'title' => __('Top Bar Icon', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#f38142',
											'selector'=> '.top-navigation-wrapper i{ color: #gdlr#; }'
										),
										...
										'main-navigation-text-hover' => array(
											...
											'selector'=> '.gdlr-main-menu > li:hover > a, .gdlr-main-menu > li.current-menu-item > a, ' .
												...
												'div#gdlr-navigation-gimmick { background-color: #gdlr#; }'
										),		
										'navigation-icon-type' => array(
											'title' => __('Navigation Icon Type', 'gdlr_translate'),
											'type' => 'combobox',
											'options' => array(
										...
										'transparent-top-bar-text-color' => array(
											'title' => __('Transparent Top Bar Text', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#b1b1b1',
											'selector'=> '.gdlr-header-transparent .top-navigation-wrapper{ color: #gdlr#; }'
										),
										'transparent-top-bar-link-color' => array(
											'title' => __('Transparent Top Bar Link', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#b1b1b1',
											'selector'=> '.gdlr-header-transparent .top-navigation-wrapper a{ color: #gdlr#; }'
										),										
										...
										'transparent-navigation-icon-type' => array(
											'title' => __('Transparent Navigation Icon Type', 'gdlr_translate'),
											'type' => 'combobox',
											'options' => array(
												'dark'=> __('Dark', 'gdlr_translate'),
												'light'=> __('Light', 'gdlr_translate'),
										...
										'search-box-background-color' => array(
											...
											'data-type' => 'rgba',
											'default' => '#2b2b2b',
											'selector'=> '.gdlr-top-woocommerce-inner, .gdlr-menu-search{ background: #gdlr#; background: rgba(#gdlra#, 0.8); }'
										),
										'search-box-text-color' => array(
											'title' => __('Header Search Box Text', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#ffffff',
											'selector'=> '.gdlr-top-woocommerce, .gdlr-top-woocommerce-inner > a, .gdlr-menu-search input[type="text"]{ color: #gdlr#; }'
										),
									)
								),		
								...
								'content-item-1' => array(
									...
									'options' => array(		
										'about-us-title' => array(
											'title' => __('About Us Title', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#4b5c72',
											'selector'=> '.gdlr-about-us-item .about-us-title{ color: #gdlr#; }'
										),
										'about-us-caption' => array(
											'title' => __('About Us Caption', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#f38142',
											'selector'=> '.gdlr-about-us-item .about-us-caption{ color: #gdlr#; }'
										),
										'about-us-divider' => array(
											'title' => __('About Us Divider', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#f38142',
											'selector'=> '.gdlr-about-us-item .about-us-divider{ border-color: #gdlr#; }'
										),
										'about-us-content' => array(
											'title' => __('About Us Content', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#4b5c72',
											'selector'=> '.gdlr-about-us-item .about-us-content{ color: #gdlr#; }'
										),	
								...
								'content-item-2' => array(
									...
									'options' => array(		
										...
										'service-slideshow-content-title' => array(
											'title' => __('Service Slideshow Content Title', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#4b5c72',
											'selector'=> '.gdlr-service-slideshow-content .service-slideshow-title{ color: #gdlr#; }'
										),
										'service-slideshow-content-border' => array(
											'title' => __('Service Slideshow Top Border', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#f87831',
											'selector'=> '.gdlr-service-slideshow-content .service-slideshow-gimmick, .gdlr-service-slideshow-content:before{ border-color: #gdlr#; }'
										),
										'service-slideshow-item-count' => array(
											'title' => __('Service Slideshow Item Count', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#ff6e17',
											'selector'=> '.gdlr-service-slideshow-item .service-slideshow-item-count{ color: #gdlr#; }'
										),
										'service-slideshow-item-content' => array(
											'title' => __('Service Slideshow Item Content', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#242424',
											'selector'=> '.gdlr-service-slideshow-item .service-slideshow-item-title{ color: #gdlr#; }'
										),
										'service-slideshow-item-hover-background-top' => array(
											'title' => __('Service Slideshow Item Active Background Top Gradient', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#ff9845'
										),
										'service-slideshow-item-hover-background' => array(
											'title' => __('Service Slideshow Item Active Background', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#f87a32',
											'data-type' => 'rgba',
											'selector'=> '.service-slideshow-overlay{ background-color: #gdlr#; }'
										),
										'service-slideshow-item-hover-content' => array(
											'title' => __('Service Slideshow Item Active Content', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#ffffff',
											'selector'=> '.gdlr-service-slideshow-item.gdlr-active .service-slideshow-item-count, .gdlr-service-slideshow-item.gdlr-active .service-slideshow-item-title{ color: #gdlr#; }'
										),
									)
								),
								
								'content-item-3' => array(
									'title' => __('Content Elements 3', 'gdlr_translate'),
									'options' => array(
										'skill-title-color' => array(
											'title' => __('Skill Item Title Color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#889eba',
											'selector'=> '.gdlr-skill-item-wrapper .gdlr-skill-item-title{ color: #gdlr#; }'
										),
										'skill-border-color' => array(
											'title' => __('Skill Item Border Color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#f5a338',
											'selector'=> '.gdlr-skill-item-wrapper .gdlr-skill-item-dot{ border-color: #gdlr#; }'
										),
										'skill-caption-color' => array(
											'title' => __('Skill Item Caption Color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#5f6a79',
											'selector'=> '.gdlr-skill-item-wrapper .gdlr-skill-item-caption{ color: #gdlr#; }'
										),
										...
										'tab-title-icon' => array(
											'title' => __('Tab Title Icon Color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#a0a0a0',
											'selector'=> '.tab-title-wrapper .tab-title span:before{ color: #gdlr#; }'
										),
										...
										'tab-title-active-color' => array(
											'title' => __('Tab Title Text Active', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#ffffff',
											'selector'=> '.tab-title-wrapper .tab-title.active, .tab-title-wrapper .tab-title.active span:before{ color: #gdlr#; }'
										),	
										'tab-title-active-background' => array(
											'title' => __('Tab Title Background Active', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#f87831',
											'selector'=> '.tab-title-wrapper .tab-title.active{ background-color: #gdlr#; }'
										),	
										'tab-slideshow-content-background' => array(
											'title' => __('Tab Slideshow Content Background', 'gdlr_translate'),
											'type' => 'colorpicker',
											'data-type' => 'rgba',
											'default' => '#ffffff',
											'selector'=> '.gdlr-tab-slideshow-item .gdlr-tab-item.vertical > .tab-content-wrapper{ background-color: #gdlr#; background-color: rgba(#gdlra#, 0.9); }'
										),	
										'tab-slideshow-content' => array(
											'title' => __('Tab Slideshow content', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#646464',
											'selector'=> '.gdlr-tab-slideshow-item .gdlr-tab-item.vertical > .tab-content-wrapper{ color: #gdlr#; }'
										),										
								...
								'blog-color' => array(
									...
									'options' => array(
										...
										'blog-info-color' => array(
											...
											'type' => 'colorpicker',
											'default' => '#a0a0a0',
											'selector'=> '.gdlr-blog-info, .blog-info a, .blog-info i{ color: #gdlr#; }'
										),
								...
								'portfolio-color' => array(
									...
									'options' => array(
										...
										'portfolio-thumbnail-hover-background-top' => array(
										...
										'portfolio-thumbnail-hover-icon' => array(
											...
											'type' => 'colorpicker',
											'default' => '#ffffff',
											'selector'=> '.gdlr-image-link-shortcode .gdlr-image-link-icon, .portfolio-thumbnail .portfolio-icon i,' . 
												'.portfolio-thumbnail .portfolio-title a, .portfolio-thumbnail .portfolio-title a:hover{ color: #gdlr#; }'
										),										
								...
								'personnel-testimonial-color' => array(
									...
									'options' => array(
										...
										'testimonial-carousel-quote' => array(
											'title' => __('Testimonial Box Background', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#f5a338',
											'selector'=> '.gdlr-testimonial-carousel-icon{ color: #gdlr#; }'
										),			
						...
						'plugin-settings' => array(
							...
							'options' => array(
								...
								'flex-slider' => array(
									...
									'options' => array(		
										'flex-carousel-auto-scroll' => array(
											'title' => __('Flex Auto Scroll', 'gdlr_translate'),
											'type' => 'checkbox',
											'default' => 'enable'
										),
