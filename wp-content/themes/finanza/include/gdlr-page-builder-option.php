			...
			$title = array(
				...
				'title-size'=> array(	
					...
					'options'=> array(
						...
						'extra-large'=> __('Extra Large' ,'gdlr_translate'),
					),
					...
					array(
									...
									'options'=>array(
										'background-type' => array(
											...
											'options' => array(
												...
												'color-2'=>__('2 Colors', 'gdlr_translate'),
												'transparent'=>__('Transparent', 'gdlr_translate'),
											)
										),
										'column-size' => array(
											'title' => __('Background Column Size', 'gdlr_translate'),
											'type' => 'combobox',
											'options'=> array(
												'1-5' => __('1/5', 'gdlr_translate'), 
												'1-4' => __('1/4', 'gdlr_translate'), 
												'2-5' => __('2/5', 'gdlr_translate'), 
												'1-3' => __('1/3', 'gdlr_translate'), 
												'1-2' => __('1/2', 'gdlr_translate'), 
												'3-5' => __('3/5', 'gdlr_translate'), 
												'2-3' => __('2/3', 'gdlr_translate'), 
												'3-4' => __('3/4', 'gdlr_translate'), 
												'4-5' => __('4/5', 'gdlr_translate'),
																							
											),
											'wrapper-class'=>'color-2-wrapper background-type-wrapper'
										),
										'background-left' => array(
											'title' => __('Background Left Color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default'=> '#ffffff',
											'wrapper-class'=>'color-2-wrapper background-type-wrapper'
										),
										'background' => array(
											'title' => __('Background ( Right ) Color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default'=> '#ffffff',
											'wrapper-class'=>'color-wrapper color-2-wrapper background-type-wrapper'
										),		
										'skin' => array(
						...
						'content-item' => array(
							...
							'options' => array(
								...
								'about-us' => array(
									'title'=> __('About Us', 'gdlr_translate'), 
									'type'=>'item',
									'options'=> array(	
										'title'=> array(
											'title'=> __('Title' ,'gdlr_translate'),
							...
							'page'=> array(
								...
								'service-slide-show' => array(
									'title'=> __('Service Slide Show', 'gdlr_translate'), 
									'type'=>'item',
									'options'=>array(
										'columns'=> array(
											'title'=> __('Only Use With Full Column', 'gdlr_translate') . '<br><br><br>' . __('Columns' ,'gdlr_translate'),
											'type'=> 'combobox',						
											'options'=> array( '3'=>'3', '4'=>'4' )
										),
										'image-1'=> array(
											'title'=> __('Service Background 1' ,'gdlr_translate'),
											'type'=> 'upload',						
											'button'=> __('upload' ,'gdlr_translate'),				
										),
										'image-inner-1'=> array(
											'title'=> __('Service Image 1' ,'gdlr_translate'),
											'type'=> 'upload',						
											'button'=> __('upload' ,'gdlr_translate'),				
										),
										'title-1'=> array(
											'title'=> __('Title 1' ,'gdlr_translate'),
											'type'=> 'text',						
										),													
										'caption-1'=> array(
											'title'=> __('Caption 1' ,'gdlr_translate'),
											'type'=> 'textarea',						
										),
										'learn-more-text-1'=> array(
											'title'=> __('Learn More Text 1' ,'gdlr_translate'),
											'type'=> 'text',	
											'default'=> __('Learn More →' ,'gdlr_translate'),				
										),													
										'learn-more-link-1'=> array(
											'title'=> __('Learn More Link 1' ,'gdlr_translate'),
											'type'=> 'text',						
										),
										'image-2'=> array(
											'title'=> __('Service Background 2' ,'gdlr_translate'),
											'type'=> 'upload',						
											'button'=> __('upload' ,'gdlr_translate'),				
										),
										'image-inner-2'=> array(
											'title'=> __('Service Image 2' ,'gdlr_translate'),
											'type'=> 'upload',						
											'button'=> __('upload' ,'gdlr_translate'),				
										),
										'title-2'=> array(
											'title'=> __('Title 2' ,'gdlr_translate'),
											'type'=> 'text',						
										),													
										'caption-2'=> array(
											'title'=> __('Caption 2' ,'gdlr_translate'),
											'type'=> 'textarea',						
										),
										'learn-more-text-2'=> array(
											'title'=> __('Learn More Text 2' ,'gdlr_translate'),
											'type'=> 'text',	
											'default'=> __('Learn More →' ,'gdlr_translate'),					
										),													
										'learn-more-link-2'=> array(
											'title'=> __('Learn More Link 2' ,'gdlr_translate'),
											'type'=> 'text',						
										),	
										'image-3'=> array(
											'title'=> __('Service Background 3' ,'gdlr_translate'),
											'type'=> 'upload',						
											'button'=> __('upload' ,'gdlr_translate'),				
										),
										'image-inner-3'=> array(
											'title'=> __('Service Image 3' ,'gdlr_translate'),
											'type'=> 'upload',						
											'button'=> __('upload' ,'gdlr_translate'),				
										),
										'title-3'=> array(
											'title'=> __('Title 3' ,'gdlr_translate'),
											'type'=> 'text',						
										),													
										'caption-3'=> array(
											'title'=> __('Caption 3' ,'gdlr_translate'),
											'type'=> 'textarea',						
										),
										'learn-more-text-3'=> array(
											'title'=> __('Learn More Text 3' ,'gdlr_translate'),
											'type'=> 'text',	
											'default'=> __('Learn More →' ,'gdlr_translate'),					
										),													
										'learn-more-link-3'=> array(
											'title'=> __('Learn More Link 3' ,'gdlr_translate'),
											'type'=> 'text',						
										),	
										'image-4'=> array(
											'title'=> __('Service Background 4' ,'gdlr_translate'),
											'type'=> 'upload',						
											'button'=> __('upload' ,'gdlr_translate'),	
											'wrapper-class'=> 'columns-wrapper 4-wrapper'
										),
										'image-inner-4'=> array(
											'title'=> __('Service Image 4' ,'gdlr_translate'),
											'type'=> 'upload',						
											'button'=> __('upload' ,'gdlr_translate'),	
											'wrapper-class'=> 'columns-wrapper 4-wrapper'				
										),
										'title-4'=> array(
											'title'=> __('Title 4' ,'gdlr_translate'),
											'type'=> 'text',	
											'wrapper-class'=> 'columns-wrapper 4-wrapper'						
										),													
										'caption-4'=> array(
											'title'=> __('Caption 4' ,'gdlr_translate'),
											'type'=> 'textarea',	
											'wrapper-class'=> 'columns-wrapper 4-wrapper'						
										),
										'learn-more-text-4'=> array(
											'title'=> __('Learn More Text 4' ,'gdlr_translate'),
											'type'=> 'text',	
											'default'=> __('Learn More →' ,'gdlr_translate'),
											'wrapper-class'=> 'columns-wrapper 4-wrapper'						
										),													
										'learn-more-link-4'=> array(
											'title'=> __('Learn More Link 4' ,'gdlr_translate'),
											'type'=> 'text',	
											'wrapper-class'=> 'columns-wrapper 4-wrapper'						
										),									
										'thumbnail-size'=> array(
											'title'=> __('Service Image Size' ,'gdlr_translate'),
											'type'=> 'combobox',
											'options'=> gdlr_get_thumbnail_list()
										),
									)
								...
								'tab-slideshow' => array(
									'title'=> __('Tab Slideshow', 'gdlr_translate'), 
									'type'=>'item',
									'options'=> array_merge(array(
										'content'=> array(
											'type'=> 'custom_chart',
											'default-title'=> __('Content', 'gdlr_translate'),
											'options'=> array(
												'title' => __('Title', 'gdlr_translate') . ':text',
												'caption' => __('Caption', 'gdlr_translate') . ':textarea',
												'background' => __('Background', 'gdlr_translate') . ':upload'
											)
										),				
										'initial-state'=> array(
											'title'=> __('Initial Tab', 'gdlr_translate'),
