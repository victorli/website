...
{name: "top-bar-icon-color", selector: ".top-navigation-wrapper i{ color: #gdlr#; }"},
...
{name: "main-navigation-text-hover", selector: ".gdlr-main-menu > li:hover > a, .gdlr-main-menu > li.current-menu-item > a, .gdlr-main-menu > li.current-menu-ancestor > a{ color: #gdlr#; opacity: 1; filter: alpha(opacity=100); }div#gdlr-navigation-gimmick { background-color: #gdlr#; }"},
{name: "transparent-top-bar-text-color", selector: ".gdlr-header-transparent .top-navigation-wrapper{ color: #gdlr#; }"},
{name: "transparent-top-bar-link-color", selector: ".gdlr-header-transparent .top-navigation-wrapper a{ color: #gdlr#; }"},
{name: "transparent-main-navigation-text", selector: ".gdlr-header-transparent .gdlr-main-menu > li > a{ color: #gdlr#; }"},
{name: "transparent-main-navigation-text-hover", selector: ".gdlr-header-transparent .gdlr-main-menu > li:hover > a, .gdlr-header-transparent .gdlr-main-menu > li.current-menu-item > a, .gdlr-header-transparent .gdlr-main-menu > li.current-menu-ancestor > a{ color: #gdlr#; }.gdlr-header-transparent div#gdlr-navigation-gimmick { background-color: #gdlr#; }"},
{name: "search-box-background-color", selector: ".gdlr-top-woocommerce-inner, .gdlr-menu-search{ background: #gdlr#; background: rgba(#gdlra#, 0.8); }"},
{name: "search-box-text-color", selector: ".gdlr-top-woocommerce, .gdlr-top-woocommerce-inner > a, .gdlr-menu-search input[type=\"text\"]{ color: #gdlr#; }"},
...
{name: "about-us-title", selector: ".gdlr-about-us-item .about-us-title{ color: #gdlr#; }"},
{name: "about-us-caption", selector: ".gdlr-about-us-item .about-us-caption{ color: #gdlr#; }"},
{name: "about-us-divider", selector: ".gdlr-about-us-item .about-us-divider{ border-color: #gdlr#; }"},
{name: "about-us-content", selector: ".gdlr-about-us-item .about-us-content{ color: #gdlr#; }"},
...
{name: "service-slideshow-content-title", selector: ".gdlr-service-slideshow-content .service-slideshow-title{ color: #gdlr#; }"},
{name: "service-slideshow-content-border", selector: ".gdlr-service-slideshow-content .service-slideshow-gimmick, .gdlr-service-slideshow-content:before{ border-color: #gdlr#; }"},
{name: "service-slideshow-item-count", selector: ".gdlr-service-slideshow-item .service-slideshow-item-count{ color: #gdlr#; }"},
{name: "service-slideshow-item-content", selector: ".gdlr-service-slideshow-item .service-slideshow-item-title{ color: #gdlr#; }"},
{name: "service-slideshow-item-hover-background-top", selector: ""},
{name: "service-slideshow-item-hover-background", selector: ".service-slideshow-overlay{ background-color: #gdlr#; }"},
{name: "service-slideshow-item-hover-content", selector: ".gdlr-service-slideshow-item.gdlr-active .service-slideshow-item-count, .gdlr-service-slideshow-item.gdlr-active .service-slideshow-item-title{ color: #gdlr#; }"},
{name: "skill-title-color", selector: ".gdlr-skill-item-wrapper .gdlr-skill-item-title{ color: #gdlr#; }"},
{name: "skill-border-color", selector: ".gdlr-skill-item-wrapper .gdlr-skill-item-dot{ border-color: #gdlr#; }"},
{name: "skill-caption-color", selector: ".gdlr-skill-item-wrapper .gdlr-skill-item-caption{ color: #gdlr#; }"},
...
{name: "tab-title-icon", selector: ".tab-title-wrapper .tab-title span:before{ color: #gdlr#; }"},
{name: "tab-title-background", selector: ".tab-title-wrapper .tab-title{ background-color: #gdlr#; }"},
{name: "tab-title-active-color", selector: ".tab-title-wrapper .tab-title.active, .tab-title-wrapper .tab-title.active span:before{ color: #gdlr#; }"},
{name: "tab-title-active-background", selector: ".tab-title-wrapper .tab-title.active{ background-color: #gdlr#; }"},
{name: "tab-slideshow-content-background", selector: ".gdlr-tab-slideshow-item .gdlr-tab-item.vertical > .tab-content-wrapper{ background-color: #gdlr#; background-color: rgba(#gdlra#, 0.9); }"},
{name: "tab-slideshow-content", selector: ".gdlr-tab-slideshow-item .gdlr-tab-item.vertical > .tab-content-wrapper{ color: #gdlr#; }"},
...
{name: "blog-info-color", selector: ".gdlr-blog-info, .blog-info a, .blog-info i{ color: #gdlr#; }"},
...
{name: "portfolio-filter-active-text", selector: ".portfolio-item-filter a:hover, .portfolio-item-filter a.active{ color: #gdlr#; }"},
...
{name: "portfolio-thumbnail-hover-icon", selector: ".gdlr-image-link-shortcode .gdlr-image-link-icon, .portfolio-thumbnail .portfolio-icon i,.portfolio-thumbnail .portfolio-title a, .portfolio-thumbnail .portfolio-title a:hover{ color: #gdlr#; }"},
...
{name: "testimonial-carousel-quote", selector: ".gdlr-testimonial-carousel-icon{ color: #gdlr#; }"},
