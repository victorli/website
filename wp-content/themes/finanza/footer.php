		...
		<div class="footer-container container">
			...
			<?php foreach( $gdlr_footer_layout[$theme_option['footer-layout']] as $footer_class ){ ?>
				<div class="footer-column <?php echo esc_attr($footer_class); ?>" id="footer-widget-<?php echo esc_attr($i); ?>" >
					<?php 
						$sidebar_id = gdlr_get_sidebar_id('Footer ' . $i);
		...
		<div class="copyright-wrapper">
			<div class="copyright-container container">
				<div class="copyright-left">
					<?php if( !empty($theme_option['copyright-left-text']) ) echo gdlr_escape_string(gdlr_text_filter($theme_option['copyright-left-text'])); ?>
				</div>
				<div class="copyright-right">
					<?php if( !empty($theme_option['copyright-right-text']) ) echo gdlr_escape_string(gdlr_text_filter($theme_option['copyright-right-text'])); ?>
				</div>
				<div class="clear"></div>
			</div>
		</div>
