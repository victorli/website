...
<?php else : ?>
    ...
    <?php endif; ?>
			...
			<fieldset id="form_btn" class="text-center col-md-12">                                
			    <a id="submit" href="#" onclick="jQuery('#commentform').submit();return false;" class="btn btn-primary wt_google_font"><span><?php esc_html_e('Post Comment', 'wt_front');?></span></a><?php comment_id_fields(); ?>  
