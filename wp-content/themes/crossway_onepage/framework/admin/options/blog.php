...
$wt_options = array(
	array(
		...
		"default" => '',
		"options" => array(
			"blog_settings" => esc_html__('Blog','wt_admin'),
			"single_post_settings" => esc_html__('Single Post','wt_admin'),
			"meta_information_settings" => esc_html__('Meta Informations','wt_admin'),
	...
	array(
		...
		array(
			"name" => esc_html__("Blog Settings",'wt_admin'),
			"type" => "wt_open"
		),
			array(
			...
			array(
				"name" => esc_html__("Featured Post Entry Type",'wt_admin'),
				...
				"options" => array(
					"full" => esc_html__('Full Width','wt_admin'),
					"left" => esc_html__('Left Float','wt_admin'),
				),
				"type" => "wt_select",
			),
			array(
				"name" => esc_html__("Display Full Blog Posts",'wt_admin'),
				"desc" => esc_html__("If the option is set to ON, the blog postswill be full displayed on the index page.",'wt_admin'),
				"id" => "display_full",
				"default" => false,
				"type" => "wt_toggle"
			),
			array(
				"name" => esc_html__("Exclude Categories",'wt_admin'),
				"desc" => esc_html__("ff you don't want to display custom categories in the blog pages, you can set them here. Also you can exclude multiple categories.",'wt_admin'),
				"id" => "exclude_categorys",
				"default" => array(),
				"target" => "cat",
				"prompt" => esc_html__("Choose category...",'wt_admin'),
				"chosen" => "true",
				"type" => "wt_multiselect",
				//"type" => "multidropdown"
			),
			array(
				"name" => esc_html__("Gap Between Posts",'wt_admin'),
	...
	array(
		...
		array(
			"name" => esc_html__("Single Post Settings",'wt_admin'),
			"type" => "wt_open"
		),
			array(
				"name" => esc_html__("Layout",'wt_admin'),
			...
			array(
				...
				"desc" => esc_html__("If the button is set to ON then the Featured Image/Slideshow/Mp3/Video will be displayed on the Single Blog post.",'wt_admin'),
				"id" => "featured_image",
				"default" => true,
				"type" => "wt_toggle"
			),
			...
			array(
				...
				"desc" => esc_html__("If the button is set to ON then the full image will be opened in the lightbox when you click on Featured Image of the Blog Single Post page.",'wt_admin'),
				"id" => "featured_image_lightbox",
				"default" => false,
				"type" => "wt_toggle"
			),
			array(
				"name" => esc_html__("About Author Box",'wt_admin'),
	...
	array(
		...
		array(
			"name" => esc_html__("Meta Informations",'wt_admin'),
			"type" => "wt_open"
		),
			array(
				"name" => esc_html__("Date",'wt_admin'),
			...
			array(
				"name" => esc_html__("Author",'wt_admin'),
			...
			array(
				"name" => esc_html__("Author Link Type",'wt_admin'),
				"desc" => "Select the link type for the author ( website link which is set in the user profile page, author's posts page or none ).",
				"id" => "author_link_type",
				"default" => 'archive',
				"options" => array(
					"website" => esc_html__('Website','wt_admin'),
					"archive" => esc_html__('Author archive','wt_admin'),
					""        => esc_html__('None','wt_admin'),
				),
				"type" => "wt_select",
			),
			array(
				"name" => esc_html__("Categories",'wt_admin'),
			...
			array(
				"name" => esc_html__("Comments",'wt_admin'),
		...
		array(
			"name" => esc_html__("Meta Informations Single Post",'wt_admin'),
			"type" => "wt_open"
		),
			array(
				"name" => esc_html__("Date",'wt_admin'),
	...
	array(
		...
		array(
			"name" => esc_html__("Full Width Featured Post Entry",'wt_admin'),
			"type" => "wt_open"
		),
			array(
				"name" => esc_html__("Blog Adaptive Height",'wt_admin'),
			...
			array(
				"name" => esc_html__("Single Adaptive Height",'wt_admin'),
				"desc" => esc_html__("If the button is set to ON then the Featured Image height depends on the original image.",'wt_admin'),
			...
			array(
				...
				"desc" => esc_html__("You can set the Featured Image Entry height for full width layouts. ( Adaptive height option above should be OFF ).  Default height is 550px.",'wt_admin'),
				"id" => "image_height",
				"min" => "1",
				"max" => "640",
				"step" => "1",
			...
			array(
				...
				"desc" => esc_html__("You can set the Featured Slide Entry height for full width layouts. Default height is 550px.",'wt_admin'),
				"id" => "slide_height",
				"min" => "1",
				"max" => "640",
				"step" => "1",
			...
			array(
				...
				"desc" => esc_html__("You can set the Featured Image Entry height for layouts with sidebar. ( Adaptive height option above should be OFF ). Default height is 250px.",'wt_admin'),
			...
			array(
				...
				"desc" => esc_html__("You can set the Featured Slide Entry height for layouts with sidebar. Default height is 400px.",'wt_admin'),
