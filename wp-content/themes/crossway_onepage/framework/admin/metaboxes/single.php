...
$options = array(
	...
	/*array(
		"name" => esc_html__("Image 1 URL",'wt_admin'),
		"id" => "_slide_image_1_url",
		"desc" => esc_html__("Here you can upload the slider images.",'wt_admin'),
		"default" => '',
		"type" => "wt_upload",
	),
	array(
		"name" => esc_html__("Image 1 Caption",'wt_admin'),
		"id" => "_slide_image_1_caption",
		"desc" => esc_html__("If you want a caption for this image then you can introduce one here.",'wt_admin'),
		"default" => '',
		"type" => "wt_text",
	),
	array(
		"name" => esc_html__("Image 2 URL",'wt_admin'),
	...
	array(
		"name" => esc_html__("Image 2 Caption",'wt_admin'),
	...
	array(
		"name" => esc_html__("Image 3 URL",'wt_admin'),
	...
	array(
		"name" => esc_html__("Image 3 Caption",'wt_admin'),
	...
	array(
		"name" => esc_html__("Image 4 URL",'wt_admin'),
	...
	array(
		"name" => esc_html__("Image 4 Caption",'wt_admin'),
	...
	array(
		"name" => esc_html__("Image 5 URL",'wt_admin'),
	...
	array(
		"name" => esc_html__("Image 5 Caption",'wt_admin'),
