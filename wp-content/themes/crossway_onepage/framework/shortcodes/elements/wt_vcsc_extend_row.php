<?php
	if (function_exists('vc_add_param')) {
		...
		vc_add_param("vc_row", array(
			'type'              			=> 'textfield',
			'heading'           			=> esc_html__( 'MP4 Video Path', 'wt_vcsc' ),
			'param_name'        			=> 'video_mp4',
			'value'             			=> '',
			'description'       			=> esc_html__( 'Enter the path to the MP4 video version.', 'wt_vcsc' ),
			'dependency' 					=> array(
				'element' 	=> 'bg_type',
				'value' 	=> 'video'
			),
		...
		vc_add_param("vc_row", array(
			'type'              			=> 'textfield',
			'heading'           			=> esc_html__( 'OGV Video Path', 'wt_vcsc' ),
			'param_name'        			=> 'video_ogv',
			'value'             			=> '',
			'description'       			=> esc_html__( 'Enter the path to the OGV video version.', 'wt_vcsc' ),
			'dependency' 					=> array(
				'element' 	=> 'bg_type',
				'value' 	=> 'video'
			),
		...
		vc_add_param("vc_row", array(
			'type'              			=> 'textfield',
			'heading'           			=> esc_html__( 'WEBM Video Path', 'wt_vcsc' ),
			'param_name'        			=> 'video_webm',
			'value'             			=> '',
			'description'       			=> esc_html__( 'Enter the path to the WEBM video version.', 'wt_vcsc' ),
			'dependency' 					=> array(
				'element' 	=> 'bg_type',
				'value' 	=> 'video'
			),
		...
		vc_add_param("vc_row", array(
			'type'							=> 'attach_image',
			'heading'						=> esc_html__( 'Video Screenshot Image', 'wt_vcsc' ),
			'param_name'					=> 'video_image',
			'value'							=> '',
			'description'					=> esc_html__( 'Select the a screenshot image for the video.', 'wt_vcsc' ),
			'dependency' 					=> array(
				'element' 	=> 'bg_type',
				'value' 	=> 'video'
			),
