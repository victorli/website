...
if (function_exists('vc_map')) {
	...
	vc_map( array(
		...
		'params'        => array(
			...
			array(
				'type'			=> 'textfield',
				'heading'		=> esc_html__( 'Image Crop Width', 'wt_vcsc' ),
				'param_name'	=> 'img_width',
				'value'			=> '9999',
				'description'	=> esc_html__( 'Enter the width in pixels.', 'wt_vcsc' ),
			),
			array(
				'type'			=> 'textfield',
				'heading'		=> esc_html__( 'Image Crop Height', 'wt_vcsc' ),
				'param_name'	=> 'img_height',
				'value'			=> '9999',
				"description"	=> esc_html__( 'Enter the height in pixels. Set to "9999" to disable vertical cropping and keep image proportions.', 'wt_vcsc' ),
			),		
			array(
				'type'          => 'dropdown',
				...
				'std'	        => 4,
				'description'   => esc_html__('Select the number of columns for your grid gallery.', 'wt_vcsc')
			),		
			array(
				'type'          => 'dropdown',
				'heading'       => esc_html__('Grid style', 'wt_vcsc'),
				'param_name'    => 'grid_style',
				'value' 		=> array(
					__( 'Default', 'wt_vcsc' )	     => '',
					__( 'No Margins', 'wt_vcsc' )	 => 'no-margins',
				),
				'description'   => esc_html__('Select the grid style for your gallery.', 'wt_vcsc')
			),
			array(
				'type'			=> 'dropdown',
				'heading'		=> esc_html__( 'Image link', 'wt_vcsc' ),
				...
				'description'	=> esc_html__( 'Where should the grid images link to?', 'wt_vcsc' ),
			),
			array(
				...
				'description'        => esc_html__( 'Enter links for images here ( Ex: <strong>http://</strong>yoursite.com ). Divide links with linebreaks (Enter). For images withought links just add linebreak (Enter) or add "#" symbol.', 'wt_vcsc' )
			),
			array(
				'type'               => 'dropdown',
				'heading'            => esc_html__( 'Custom links target', 'wt_vcsc' ),
			...
			array(
				'type'          => 'checkbox',
				'heading'       => esc_html__('Display title?', 'wt_vcsc'),
				'param_name'    => 'title',
				'value'         => Array( esc_html__('Yes, please', 'wt_vcsc') => 'yes'),
				'description'   => esc_html__('If selected, the image title will be displayed.', 'wt_vcsc')
			),
			array(
				'type'          => 'checkbox',
