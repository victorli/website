...
if (function_exists('vc_map')) {
	...
	vc_map( array(
		'name'          => esc_html__('WT Google Map', 'wt_vcsc'),
		'base'          => 'wt_gmap',
		'icon'          => 'wt_vc_ico_gmap',
		'class'         => 'wt_vc_sc_gmap',
		'category'      => esc_html__('by WhoaThemes', 'wt_vcsc'),
		'description'   => esc_html__('Google map with custom markers', 'wt_vcsc'),
		'params'        => array(
			array(
				'type'          => 'textfield',
				'heading'       => esc_html__('Map address', 'wt_vcsc'),
				'holder'        => 'div',
				'param_name'    => 'address',
				'description'   => esc_html__('Address where the map should point (ex. "London, UK").', 'wt_vcsc')
			),
			array(
				'heading'       => 'Map markers',
			...
			array(
				'type'          => 'wt_range',
				'heading'       => esc_html__( 'Map height', 'wt_vcsc' ),
				'param_name'    => 'height',
				'value'         => '100',
				'min'           => '100',
				'max'           => '1000',
				'step'          => '1',
				'unit'          => 'px',
				'description'   => esc_html__( 'Height of the map in px.', 'wt_vcsc' ),
				'group'         => esc_html__('Advanced map settings', 'wt_vcsc')
			),
			
			array(
				'type'          => 'wt_range',
				'heading'       => esc_html__( 'Map zoom', 'wt_vcsc' ),
				'param_name'    => 'zoom',
				'value'         => '14',
				'min'           => '0',
				'max'           => '19',
				'step'          => '1',
				//'unit'          => 'px',
				'description'   => esc_html__( 'Map zoom level from 0 to 19.', 'wt_vcsc' ),
				'group'         => esc_html__('Advanced map settings', 'wt_vcsc')
			),
			array(
				'type'			=> 'checkbox',
				'heading'		=> esc_html__('Fit markers?','wt_vcsc'),
				'param_name'	=> 'fit_bounds',
				'value'			=> Array( esc_html__('Yes please.', 'wt_vcsc') => true),
				'description'   => esc_html__( 'Set map zoom to cover all visible markers.', 'wt_vcsc' ),
				'group'         => esc_html__('Advanced map settings', 'wt_vcsc')
			),
			array(
				'type'			=> 'checkbox',
				'heading'		=> esc_html__('Center & zoom on marker click?','wt_vcsc'),
				'param_name'	=> 'center_on_markerclick',
				'value'			=> Array( esc_html__('Yes please.', 'wt_vcsc') => true),
				'description'   => esc_html__( 'Auto center & zoom the map on marker click event.', 'wt_vcsc' ),
				'group'         => esc_html__('Advanced map settings', 'wt_vcsc')
			),
			array(
				'type'			=> 'checkbox',
				'heading'		=> esc_html__('Group / cluster markers?','wt_vcsc'),
				'param_name'	=> 'clusters',
				'value'			=> Array( esc_html__('Yes please.', 'wt_vcsc') => true),
				'description'   => esc_html__( 'Group markers that are relatively close together into marker areas.', 'wt_vcsc' ),
				'group'         => esc_html__('Advanced map settings', 'wt_vcsc')
			),
			/*
			array(
				'type'			=> 'checkbox',
				'heading'		=> esc_html__('Draggable?','wt_vcsc'),
				'param_name'	=> 'draggable',
				'value'			=> Array( esc_html__('Yes please.', 'wt_vcsc') => 'yes'), 
				'std'           => 'yes',
				'description'   => esc_html__( 'If false, prevents the map from being dragged.', 'wt_vcsc' ),
				'group'         => esc_html__('Advanced map settings', 'wt_vcsc')
			),
			*/
			array(
				'type'			=> 'checkbox',
				'heading'		=> esc_html__('Scroll wheel?','wt_vcsc'),
				'param_name'	=> 'scrollwheel',
				'value'			=> Array( esc_html__('Yes please.', 'wt_vcsc') => true),
				'description'   => esc_html__( 'If false, disables scrollwheel zooming in Street View.', 'wt_vcsc' ),
				'group'         => esc_html__('Advanced map settings', 'wt_vcsc')
			),
			array(
				'type'          => 'textarea_raw_html',
				'heading'       => esc_html__('Map theme', 'wt_vcsc'),
				'holder'        => 'div',
				'param_name'    => 'theme',
				'value'         => base64_encode(''),
				'description'   => esc_html__('JavaScript Style Array. Set your own style or see ', 'wt_vcsc') . '<a href="http://snazzymaps.com/" target="_blank">http://snazzymaps.com</a>' . esc_html__(' for more free themes. Also you can use ', 'wt_vcsc') . '<a href="http://gmaps-samples-v3.googlecode.com/svn/trunk/styledmaps/wizard/index.html" target="_blank">this online editor</a>' . esc_html__(' to create a personalized google map. Copy / paste here the JSON array.', 'wt_vcsc'),
				'group'         => esc_html__('Advanced map settings', 'wt_vcsc')
			),
			array(
				'heading'       => '',
