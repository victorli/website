...
if (function_exists('vc_map')) {
	...
	vc_map( array(
		'name'          => esc_html__('WT Spacer / Clear', 'wt_vcsc'),
		'base'          => 'wt_spacer',
		'icon'          => 'wt_vc_ico_spacer',
		'class'         => 'wt_vc_sc_spacer',
		'category'      => esc_html__('by WhoaThemes', 'wt_vcsc'),
		'description'   => esc_html__('Place space / clear element', 'wt_vcsc'),
		'params'        => array(
			array(
				'type'        => 'wt_range',
				'heading'     => esc_html__( 'Spacer height', 'wt_vcsc' ),
                "admin_label" => true,
				'param_name'  => 'height',
				'value'       => 10,
				'min'         => 0,
				...
				'step'        => 1,
				'unit'        => 'px',
				'description' => esc_html__( 'Define spacer height in px.', 'wt_vcsc' )
			),
			// Extra Settings
			array(
				'type'		  => 'wt_separator',
				...
				'description' => esc_html__( 'Below you can add extra settings.', 'wt_vcsc' )
			),
			array(
				'type'               => 'textfield',
