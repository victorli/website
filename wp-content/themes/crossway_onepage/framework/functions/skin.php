...
.woocommerce-page .widget_price_filter .ui-slider .ui-slider-handle:last-child {
	background: rgb({$rgbEq});
	background: rgba({$rgbEq},0.8); }
.woocommerce .widget_price_filter .ui-slider .ui-slider-handle, 
.woocommerce-page .widget_price_filter .ui-slider .ui-slider-handle {
	border-color: rgb({$rgbEq});
	border-color: rgba({$rgbEq},0.8); }
.wt_pricing_box_sc.wt_pricing_featured .wt_plan_price {
	border-top-color: rgb({$rgbEq});
	border-top-color: rgba({$rgbEq},0.8); }
.wt_pricing_box_sc.wt_pricing_featured .wt_plan_price {
	border-bottom-color: rgb({$rgbEq});
	border-bottom-color: rgba({$rgbEq},0.8); }
.wt_search_form .search-btn,
.contact_button,
.wt_color_overlay {
	background: rgb({$rgbEq}); 
...
.mc4wp-form input[type="submit"]:hover,
.wpcf7-form input[type="submit"]:hover {
	background: rgb({$rgbEq}) !important; 
	background: rgba({$rgbEq},0.8) !important; }
...
.wp-pagenavi > span:focus {
	background-color: rgb({$rgbEq});
	border-color: rgb({$rgbEq});
	background-color: rgba({$rgbEq},0.8);
	border-color: rgba({$rgbEq},0.8); }
.wt_loader_html {
