    	...
    	<div class="container">
			<?php if(!wt_get_option('general','display_logo') && $custom_logo = wt_get_option('general','logo')): ?>			
                <div id="logo" class="navbar-header">
                    <?php if($enable_retina): ?>
                        ...
                        <?php else:?>
                            <a class="navbar-brand" href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo esc_url( $custom_logo ); ?>" data-at2x="<?php echo esc_url( $retinaLogoAlt ); ?>" alt="" /></a>
                        <?php endif; ?> 
                    <?php else:?>
                        <?php if(is_front_page()): ?>
            ...
            <?php else:?>
                <div id="logo" class="logo_text navbar-header">
                    <a class="navbar-brand" href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php echo esc_html( wt_get_option('general','plain_logo') ); ?></a>
            ...
            <?php endif; ?>  
            <div id="headerWidget"> <?php dynamic_sidebar(esc_html__('Header Area','wt_admin')); ?> </div> 
            <?php  		
