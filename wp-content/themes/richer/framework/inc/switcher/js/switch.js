...
function changeFontHeadings(font) {
	...
	jQuery('<link rel="stylesheet" href="http://fonts.useso.com/css?family='+font.replace(" ", "+")+':400,700" type="text/css" id="headings_font" media="all">').appendTo('head');
...
function changeFontText(font2) {
	...
	jQuery('<link rel="stylesheet" href="http://fonts.useso.com/css?family='+font2.replace(" ", "+")+':400,700" type="text/css" id="text_font" media="all">').appendTo('head');
