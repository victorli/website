...
if ( isset( $google_fonts_data['values']['font_family'] ) ) {
	wp_enqueue_style( 'vc_google_fonts_' . vc_build_safe_css_class( $google_fonts_data['values']['font_family'] ), '//fonts.useso.com/css?family=' . $google_fonts_data['values']['font_family'] . $subsets );
}
