...
function wp_default_scripts( &$scripts ) {
	...
	//$scripts->add( 'prototype', 'http://lib.sinaapp.com/js/prototype/1.7.0.0/prototype.js', array(), '1.7.1');
	//$scripts->add( 'scriptaculous-root', 'http://lib.sinaapp.com/js/scriptaculous/1.9.0/scriptaculous.js', array('prototype'), '1.9.0');
